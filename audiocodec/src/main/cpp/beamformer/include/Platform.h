...
#if defined(__LITTLE_ENDIAN__) || defined(__LITTLE_ENDIAN) || (__BYTE_ORDER__ == __ORDER_LITTLE_ENDIAN__)
#define OS_ARCH_LITTLEENDIAN
#elif defined(__BIG_ENDIAN__) || defined(__BIG_ENDIAN) || (__BYTE_ORDER__ == __ORDER_BIG_ENDIAN__)
#define OS_ARCH_BIGENDIAN
#else
#error "Unknown little endian or big endian architecture"
#endif

#if defined(_M_X64)      || defined(__x86_64__) || \
    defined(__aarch64__) || defined(__arm64__)  || \
    defined(__LP64__)    || defined(__ia64__)
#define OS_ARCH_64_BITS
#elif defined(_M_IX86)    || defined(__i386__) || \
      defined(__ARMEL__)  || defined(__arm__)  || \
      defined(__MIPSEL__) || defined(__pnacl__)
#define OS_ARCH_32_BITS
#else
#error "Unknown architecture bits"
#endif

#if defined(_M_X64) || defined(__x86_64__) || defined(_M_IX86) || defined(__i386__)
#define OS_ARCH_X86_FAMILY
#elif defined(__ARMEL__) || defined(__arm__) || defined(__aarch64__) || defined(__arm64__)
#define OS_ARCH_ARM_FAMILY
#elif defined(__MIPSEL__) || defined(__MIPSEB__) || defined(__mips__)
#define OS_ARCH_MIPS_FAMILY
#else
...
#define icm_realloc(ptr,size) realloc(ptr,size)
#define icm_free(ptr) if(ptr) { free(ptr); ptr = 0; }
